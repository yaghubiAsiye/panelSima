...
{{--                                        </tfoot>--}}
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">ثبت انتقاد یا پیشنهاد </h4>
                                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form style="font-family:Byekan" action="/Suggestions" enctype="multipart/form-data"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="fa fa-paperclip"></i> شرح انتقاد /
                                                پیشنهاد </h4>
                                            ...
                                            <div style="" class="col-md-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="form-group row last">
                                                        <label class="col-md-3 label-control" for="attachment">آپلود
                                                            فایل ضمیمه</label>
                                                        <div class="col-md-9">
                                                            <input type="file" id="attachment" class="form-control"
                                                                   name="attachment">
