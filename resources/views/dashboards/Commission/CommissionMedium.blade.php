  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel17">افزودن کمیسیون متوسط </h4>
      ...
      <div class="modal-body">
        ...
        <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post" action="SellersContracts" class="form form-horizontal form-bordered striped-rows">
          ...
          <div style="font-family:byekan" class="form-body">
            <h4 class="form-section"><i class="ft-user"></i> کمیسیون متوسط</h4>
            ...
            <div  class="form-group row last">
                <label class="col-md-3 label-control" for="contractorFile">بارگزاری مدارک مورد نیاز</label>
                <div class="col-md-9">
              ...
              <div class="form-group row">
                <label class="col-md-3 label-control" for="contractor">اسامی تامین کنندگان </label>
                <div class="col-md-9">
                  <input type="text" id="contractor" class="form-control"  name="tarafedovvom">
                </div>
              </div>
            ...
            <div class="form-group row">
                <label class="col-md-3 label-control" for="contractor">محل تحویل کالا</label>
                <div class="col-md-9">
                  <input type="text" id="contractor" class="form-control"  name="tarafedovvom">
                </div>
              </div>
            ...
            <div class="form-group row last">
              <label class="col-md-3 label-control" for="from">هزینه های حمل  </label>
              <div class="col-md-9">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">لیست کمیسیون های متوسط</h4>
