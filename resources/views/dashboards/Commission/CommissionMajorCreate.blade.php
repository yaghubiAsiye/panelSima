                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ثبت معامله عمده برای با عنوان {{ $PurchaseRequest->onvan}} </h4>
                                                    ...
                                                    <form style="vertical-align:center;text-align:center" enctype="multipart/form-data" method="post" action="/CommissionMajor" class="form form-horizontal form-bordered striped-rows">
                                                        ...
                                                        <div style="font-family:byekan" class="form-body">
                                                          ...
                                                          <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                              <input type="text" id="name" class="form-control"  name="mozoo">
                                                            </div>
                                                          </div>
                                                          ...
                                                          <div class="form-group row">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input style="font-family:Byekan" class="form-control" style="" placeholder="کلیک کنید" autocomplete="off" name="datebargozari" type="text" id="input1"/>
                                                          ...
                                                          <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                              <input type="text" id="contractor" class="form-control"  name="arzeshmoamele">
                                                            </div>
                                                          </div>
                                                          ...
                                                          <div class="form-group row">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input type="text" id="contractor" class="form-control"  name="tedadtaminkonandegan">
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row last">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input type="text" id="from" class="form-control"  name="mahaltahvil">
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row last">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input type="text" id="to" class="form-control" name="hazinehaml">
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row last">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input type="text" id="from" class="form-control"  name="garanti">
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row last">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input type="text" id="from" class="form-control"  name="khadamatpasazforosh">
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row last">
                                                              ...
                                                              <div class="col-md-9">
                                                                <input type="text" id="from" class="form-control"  name="modatmoamele">
                                                              </div>
                                                            </div>
