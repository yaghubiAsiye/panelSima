            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div style="text-align: center!important;" class="modal-header">
                        <h4 style="text-align: center!important;" class="modal-title" id="ReferralsTdl{{ $phoneBook->id }}">دستورالعمل </h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div  style=" direction: rtl;" class="modal-body">
                        ...
                        <form style="vertical-align:center;text-align:center" method="post" action="instruction/update/{{ $phoneBook->id }}"  enctype="multipart/form-data" class="form form-horizontal form-bordered striped-rows">
                            @csrf
                            <div class="form-body">
                                        ...
                                        @foreach($archives as $archive)
                                            <tr>
                                                ...
                                                <td style="text-align: center;vertical-align: center;font-size: 20px;color: #3BAFDA; " >
                                                    <a target="_blank" href="{{ $archive->file }}"> {!! $archive->file !== "storage/regulations/nothing" ? "<i class='ft-file-text' ></i>" : "" !!} </a>
                                                </td>
