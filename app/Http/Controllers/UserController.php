...
class UserController extends Controller
{
  ...
  */
  public function update(Request $request)
  {
    ...
    ->update([
      'residingName' => $request->residingName,
      'tower' => $request->tower,
      'floor' => $request->floor,
      'unit' => $request->unit,
      'residingNationalCode' => $request->residingNationalCode,
      'residingMobileNumber' => $request->residingMobileNumber,
      'warehouseCode' => $request->warehouseCode,
      'warehouseSize' => $request->warehouseSize,
      'parkingCode1' => $request->parkingCode1,
      'parkingCode2' => $request->parkingCode2,
      'parkingCode3' => $request->parkingCode3,
      'parkingCode4' => $request->parkingCode4,
      'ownerName' => $request->ownerName,
      'ownerNationalCode' => $request->ownerNationalCode,
      'ownerMobileNumber' => $request->ownerMobileNumber,
      'homePhoneNumber1' => $request->homePhoneNumber1,
      'homePhoneNumber2' => $request->homePhoneNumber2,
      'homePhoneNumber3' => $request->homePhoneNumber3,
      'email' => $request->email,
    ]);
